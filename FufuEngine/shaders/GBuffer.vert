...
void main() {
    ...
    // Add per-triangle submesh index so the fragment shader picks the right
    // material slot when SubMeshMaterialsComponent is in use.
    v_MaterialIndex = materialIndex + attributes[triIdx].materialIndex;
