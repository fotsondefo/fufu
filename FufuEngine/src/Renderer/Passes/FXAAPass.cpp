...
namespace Fufu
{
	...
	// ----------------------------------------------------------------
	// FXAA — post-process using luminance contrast detection. Sources
	// loaded from shaders/FullscreenQuad.vert and shaders/FXAA.frag — see
	// ShaderUtils::loadShaderSource, and FXAA.frag for algorithm details.
	// ----------------------------------------------------------------
