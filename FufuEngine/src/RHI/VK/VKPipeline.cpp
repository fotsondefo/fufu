    ...
    : m_Device(device)
{
    ...
    // No vertex buffer — shaders fetch vertices via SSBOs
    ...
    // Dynamic viewport & scissor (set via vkCmdSetViewport/Scissor)
    ...
    // Multiple color attachments may be present (e.g. G-Buffer: 3)
