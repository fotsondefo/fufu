...
// GLFW for the surface (GLFW_INCLUDE_VULKAN is defined in depch.h for VK translation units)
      ...
      m_Device(device), m_GraphicsFamily(graphicsFamily), m_Desc(desc)
{
    ...
    // Semaphores per frame-in-flight
...
// Base-interface stubs — VKContext bypasses them with the VK overrides
