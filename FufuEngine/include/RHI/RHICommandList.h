...
// ── Layout barrier (no-op GL, VkPipelineBarrier2 on VK side) ─────────────────
...
public:
    ...
    // ── Resources (slot = GL binding point / VK descriptor binding) ──────────
    ...
    // WHOLE_SIZE is defined in RHIBuffer.h (included via RHIBuffer.h)
};
