...
// Included by VK translation units (FUFU_VK_BACKEND defined → glad excluded from pch.h).
// This header brings in Vulkan + VMA + GLFW Vulkan + helpers.
