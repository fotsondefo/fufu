...
public:
    ...
    // Resets internal state at the beginning of a frame
    void reset();

private:
    // Persistent FBO: re-attached at each beginRenderPass()
    GLuint m_FBO         = 0;
    GLuint m_DummyVAO    = 0; // empty VAO required by the core profile
